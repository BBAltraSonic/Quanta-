...
class AIService {
  ...
  Future<String> _generateOpenRouterResponse(String context, AvatarModel avatar) async {
    ...
    final response = await http.post(
      ...
      body: jsonEncode({
        ...
        'messages': [
          {
            'role': 'system',
            'content': avatar.personalityPrompt,
          },
          {
            'role': 'user',
            'content': context,
  ...
  Future<String> _generateHuggingFaceResponse(String context, AvatarModel avatar) async {
  ...
  String _buildChatContext(AvatarModel avatar, String userMessage, List<ChatMessage> recentMessages) {
    ...
    contextBuffer.writeln('Personality traits: ${avatar.personalityTraitsDisplayText}');
  ...
  String _generateFallbackResponse(AvatarModel avatar, String userMessage) {
    ...
    if (nicheContext.isNotEmpty && userMessage.toLowerCase().contains(_getNicheKeywords(avatar.niche))) {
